      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        ...
        <div className="relative bg-gray-900 rounded-xl p-6 w-full max-w-md border border-gray-700">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-medium text-white">Share Image</h2>
            <button
              onClick={onClose}
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="flex-1 py-2 px-4 bg-[#5865F2] hover:bg-[#4752C4] rounded-lg text-white transition-colors flex items-center justify-center space-x-2"
              >
